...
export const customFetch = async (
    ...
    try {
        ...
        // if we are in dev env use localhost for reactAppUrl
...
export enum NetworkCode {
     ...
     * to list files with different filename extensions, or to suggest word-sense
     * disambiguation.
     */
     ...
     * presume that
     * the server has received the data and should issue a redirect with a separate
     *  GET message.
     */
    SEE_OTHER = 303,
     ...
     * teapots requested to brew coffee. This HTTP status is used as an Easter egg
     ...
     * when meanwhile a third party has modified the state on the server, leading
     *  to a conflict."
     */
     ...
     * or to a set of resources
     * that includes the requested resource. The code 451 was chosen as a reference
     *  to the novel Fahrenheit 451.
     */
     ...
     * Usually this implies future availability (e.g., a new feature of a web-service
     * API).
     */
    NOT_IMPLEMENTED = 501,
